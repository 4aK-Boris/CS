...
@Factory
class GetAllSteamAccountsUseCase(@Provided private val databaseSteamAccountRepository: DatabaseSteamAccountRepository) : BaseUseCase {

    suspend operator fun invoke(): Result<List<SteamAccountDTO>> = runCatching {
        databaseSteamAccountRepository.getAllSteamAccounts()
    }
}
