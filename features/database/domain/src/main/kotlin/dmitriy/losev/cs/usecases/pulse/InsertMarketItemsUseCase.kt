...
//
//@Factory
//class InsertMarketItemsUseCase(@Provided private val marketTradeRepository: MarketTradeRepository): BaseUseCase {
//
//    suspend operator fun invoke(markerItems: List<MarketItemDTO>): Result<Unit> = runCatching {
//        marketTradeRepository.insertMarkerItems(markerItems)
//    }
//}
