...
//    override suspend fun getConfirmations(steamId: Long, deviceId: String, confirmationKey: String): ConfirmationsResponseDTO {
//        return confirmationsResponseMapper.map(value = steamMobileNetwork.getConfirmations(steamId, deviceId, confirmationKey))
//    }
//
//    override suspend fun confirmTrade(steamId: Long, deviceId: String, confirmationKey: String, confirmation: ConfirmationDTO): Boolean {
//        return steamMobileNetwork.confirmTrade(steamId, deviceId, confirmationKey, confirmationMapper.map(value = confirmation))
//    }
//
//    override suspend fun getRSAKey(steamId: Long, login: String): RSAKeyDTO {
...
//    }
//
//    override suspend fun getTradeOffers(steamId: Long): List<TradeOfferInfoDTO> {
