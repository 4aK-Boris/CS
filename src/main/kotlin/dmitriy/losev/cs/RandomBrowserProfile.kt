...
data class RandomBrowserProfile(
    ...
    val timezone: String,
    val platform: String,           // "Windows"|"MacIntel"|"Linux x86_64"
    val navigatorPlatform: String,  // для navigator.platform
    val viewport: Pair<Int, Int>,   // width x height
    val deviceScaleFactor: Double,
    val hardwareConcurrency: Int,   // 2..16
    val deviceMemory: Int           // 2..16 (условно, ГБ)
)
...
object ProfileRandomizer {
    ...
    fun random(): RandomBrowserProfile {
        ...
        val dpr = listOf(1.0, 1.25, 1.5, 1.75, 2.0)[pick(5)]
